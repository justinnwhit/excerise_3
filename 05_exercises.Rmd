...
world <- get_stamenmap(
    bbox = c(left =-79.5867, bottom =8.8934, right =-79.4160, top = 9.0156), 
    maptype = "terrain",
    zoom = 10)
...
cases_anim<-cases_with_2018_pop_est %>%
  drop_na() %>% 
  ggplot() +
...
animate(cases_anim, duration = 200, start_pause = 10, end_pause = 10)
